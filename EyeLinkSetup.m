...
Eyelink('command','calibration_targets = %d,%d %d,%d %d,%d %d,%d %d,%d',...
    round(width * 0.15),round(height*0.15), round(width * 0.15),round(height - height*0.15),...
    round(width - width * 0.15),round(height - height*0.15), round(width - width * 0.15),round(height*0.15),...
    width/2,height/2);
